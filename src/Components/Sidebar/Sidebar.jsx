...
function Sidebar() {
  return (<><button data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar" aria-controls="separator-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
    ...
    <aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          <li>
            <a href="#" class="flex items-center py-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <p class="mx-auto text-sky-500 text-medium">Dash<span className='text-black'>Stack</span></p>
            </a>
          </li>
          <NavLink>
            <a href="#" class="py-3 flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-sky-500 hover:text-white  dark:hover:bg-gray-700 group">
          ...
          <NavLink>
            <a href="#" class="py-3 flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-sky-500 hover:text-white  dark:hover:bg-gray-700 group">
              ...
              <span class=" ms-3 whitespace-nowrap">Favorite</span>
            </a>
          </NavLink>
          <NavLink>
            <a href="#" class="py-3 flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-sky-500 hover:text-white  dark:hover:bg-gray-700 group">
          ...
          <NavLink>
            <a href="#" class="py-3 flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-sky-500 hover:text-white  dark:hover:bg-gray-700 group">
              ...
              <span class=" ms-3 whitespace-nowrap">Order List</span>
            </a>
          </NavLink><NavLink>
            <a href="#" class="py-3 flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-sky-500 hover:text-white  dark:hover:bg-gray-700 group">
              
              <span class=" ms-3 whitespace-nowrap">Product Stock</span>
            </a>
          </NavLink>
