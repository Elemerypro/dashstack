    ...
    <aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 ">
        <ul className="space-y-2 font-medium">
          <li>
            <NavLink href="#" class="flex items-center py-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <p class="mx-auto text-sky-500 text-medium">Dash<span className='text-black'>Stack</span></p>
            </NavLink>
          </li>
          <li to=''>
            <NavLink href="#" class="py-3 flex items-center p-2 text-gray-900 rounded-md dark:text-white hover:bg-sky-500 hover:text-white  dark:hover:bg-gray-700 group">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
          <li>
              <NavLink href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
